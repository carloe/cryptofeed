...
class KrakenFutures(Feed):
    ...
    async def _book_snapshot(self, msg: dict, pair: str, timestamp: float):
        ...
        # not a duplicate argument: the positional is the receipt time, the kwarg is Kraken's own clock
    ...
    async def message_handler(self, msg: str, conn, timestamp: float):
        ...
        if 'event' in msg:
            ...
            # Websocket product_id matches the REST API symbol verbatim (both uppercase, e.g. PF_XBTUSD)
